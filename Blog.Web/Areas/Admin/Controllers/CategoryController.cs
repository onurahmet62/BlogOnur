...
namespace Blog.Web.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public CategoryController(IUserService userService, ICategoryService categoryService, IValidator<Category> validator, IMapper mapper, IToastNotification toast)
        {
